...
if __name__ == '__main__':
    label_path=r'C:\Users\14833\Desktop\yolov5-6.1_official\datasets\railroad\test\labels'+'\\'  #标签所存放的路径
    ...
    names= ['person','hamlet','vest']
    # names=['rcall','rtype','lcall','ltype','radio','drink','talk','fetch','tomb']
